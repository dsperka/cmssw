...
class PrimaryVertexProducerCUDA_CPUFitter : public edm::stream::EDProducer<> {
public:
  PrimaryVertexProducerCUDA_CPUFitter(const edm::ParameterSet&);
  ~PrimaryVertexProducerCUDA_CPUFitter() override;
